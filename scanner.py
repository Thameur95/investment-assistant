...
import pandas as pd
 
# Lecture de la liste des actions
with open("stocks.txt", "r", encoding="utf-8") as file:
tickers = [line.strip() for line in file if line.strip()]
 
print("\n=== INVESTMENT ASSISTANT V1 ===\n")
 
for ticker in tickers:
try:
# Téléchargement des 3 derniers mois
data = yf.download(
ticker,
period="3mo",
interval="1d",
...
score += 40
reasons.append("Prix supérieur à la MM20")
 
...
score += 30
reasons.append("Performance sur 5 jours supérieure à 3 %")
 
...
print("Motifs : aucun critère validé")
 
print("-" * 40)
 
